      ...
      <div class="row justify-content-center">
          <div class="col-12 col-lg-7">
              <div class="image-wrapper">
                  <img src="{{asset('master/assets/images/brand-mark-color1-1056x523.png')}}" alt="Mobirise">
          ...
          <div class="col-sm-6 col-lg-3">
              <div class="card-wrap">
                  ...
                  <div class="content-wrap">
                      ...
                      <div class="social-row display-7">
                          <div class="soc-item">
                              <a href="https://www.linkedin.com/in/mugiraneza-himbaza-yves-240957154/" target="_blank">
                                  <span class="mbr-iconfont socicon-linkedin socicon"></span>
                              </a>
                          </div>
                          <div class="soc-item">
