                    ...
                    @csrf
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								 <input name="title" type="text" class="form-control" value="{{Request::old('title')}}"  required placeholder="Book title">
							</div>
						</div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<select required name="level" class="custom-select col-12">
